...
public class ExoPlayerManager {
    ...
    private ExoPlayerManager(Context mContext) {
        ...
        dataSourceFactory = new DefaultDataSourceFactory(mContext,
                Util.getUserAgent(mContext, "ExoPlayer"), BANDWIDTH_METER);
    ...
    public void setPlaylist(ArrayList<String> uriArrayList, Integer index,
            Callbacks.playerCallBack callBack) {
